...
export const responseHeaders: HeadersFunction = ({ loaderHeaders, parentHeaders }) => {
	...
	return {
		...
		"Content-Security-Policy":
			"default-src 'self'; script-src 'self' 'unsafe-inline'; style-src 'self' https://cdnjs.cloudflare.com; img-src 'self' https://cdnjs.cloudflare.com; object-src 'none'; frame-ancestors 'self'; base-uri 'self'; connect-src 'self' ws://localhost:3001;",
